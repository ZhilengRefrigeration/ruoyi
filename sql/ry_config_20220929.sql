...
(8, 'ruoyi-file-dev.yml', 'DEFAULT_GROUP', '# 本地文件上传    \nfile:\n  #http or https \n  tls: http \n  #如需启动多个本地file服务 则置空domain 防止负载均衡导致文件无法找到  \n  domain: 127.0.0.1\n  port: 9300\n  path: D:/ruoyi/uploadPath\n  prefix: /statics\n\n# FastDFS配置\nfdfs:\n  domain: http://8.129.231.12\n  soTimeout: 3000\n  connectTimeout: 2000\n  trackerList: 8.129.231.12:22122\n\n# Minio配置\nminio:\n  url: http://8.129.231.12:9000\n  accessKey: minioadmin\n  secretKey: minioadmin\n  bucketName: test', '45885a3496a5561823345c76d11951f8', '2020-11-20 00:00:00', '2023-05-31 02:41:13', 'nacos', '0:0:0:0:0:0:0:1', '', '', '文件服务', 'null', 'null', 'yaml', '', ''),
