...
INSERT INTO `config_info` VALUES (8, 'ruoyi-file-dev.yml', 'DEFAULT_GROUP', '# 本地文件上传    \nfile:\n    domain: http://127.0.0.1:9300\n    path: D:/ruoyi/uploadPath\n    prefix: /statics\n\n# FastDFS配置\nfdfs:\n  domain: http://8.129.231.12\n  soTimeout: 3000\n  connectTimeout: 2000\n  trackerList: 8.129.231.12:22122\n\n# Minio配置\nminio:\n  url: http://8.129.231.12:9000\n  accessKey: minioadmin\n  secretKey: minioadmin\n  bucketName: test\n\n# 阿里云OSS配置\noss:\n  accessKey: 你的公钥\n  secretKey: 你的秘钥\n  endpoint: 存储桶节点域名\n  bucketName: 存储桶名称', 'c24e64c9fc73fe2968892c278533a3e1', '2020-11-20 00:00:00', '2022-10-13 09:59:36', 'nacos', '127.0.0.1', '', '', '文件服务', 'null', 'null', 'yaml', '', '');
...
-- ----------------------------
INSERT INTO `his_config_info` VALUES (8, 1, 'ruoyi-file-dev.yml', 'DEFAULT_GROUP', '', '# 本地文件上传    \r\nfile:\r\n    domain: http://127.0.0.1:9300\r\n    path: D:/ruoyi/uploadPath\r\n    prefix: /statics\r\n\r\n# FastDFS配置\r\nfdfs:\r\n  domain: http://8.129.231.12\r\n  soTimeout: 3000\r\n  connectTimeout: 2000\r\n  trackerList: 8.129.231.12:22122\r\n\r\n# Minio配置\r\nminio:\r\n  url: http://8.129.231.12:9000\r\n  accessKey: minioadmin\r\n  secretKey: minioadmin\r\n  bucketName: test', '5382b93f3d8059d6068c0501fdd41195', '2022-10-13 17:58:39', '2022-10-13 09:58:40', 'nacos', '127.0.0.1', 'U', '', NULL);
INSERT INTO `his_config_info` VALUES (8, 2, 'ruoyi-file-dev.yml', 'DEFAULT_GROUP', '', '# 本地文件上传    \nfile:\n    domain: http://127.0.0.1:9300\n    path: D:/ruoyi/uploadPath\n    prefix: /statics\n\n# FastDFS配置\nfdfs:\n  domain: http://8.129.231.12\n  soTimeout: 3000\n  connectTimeout: 2000\n  trackerList: 8.129.231.12:22122\n\n# Minio配置\nminio:\n  url: http://8.129.231.12:9000\n  accessKey: minioadmin\n  secretKey: minioadmin\n  bucketName: test\n\n# 阿里云OSS配置\noss:\n  accessKey: LTAI5t9nuJ7fxhVrwXD7iHxQ\n  secretKey: lvuroJNMqx6SNHLkHK8aRSnsrh5JDd\n  endpoint: oss-cn-chengdu.aliyuncs.com\n  bucketName: my-oss-service', '37a5dfc611bdbb300def09bf529508f8', '2022-10-13 17:59:35', '2022-10-13 09:59:36', 'nacos', '127.0.0.1', 'U', '', NULL);
