/*
 ...
 Source Schema         : xjs-mall

 Target Server Type    : MySQL
 Target Server Version : 80027
 File Encoding         : 65001

 Date: 08/04/2022 17:01:52
*/
...
CREATE TABLE `pms_attr`  (
  ...
  `icon` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '属性图标',
  ...
  `value_type` tinyint NULL DEFAULT NULL COMMENT '值类型（单选、多选）',
  PRIMARY KEY (`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505155604445609987 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1504719409409875969, '颜色', 0, 'cascader', '黑色;黄色;红色;绿色', 0, 1, 225, 0, 1);
INSERT INTO `pms_attr` VALUES (1505154845024927745, '内存', 0, 'icon_zhuye', '6+128;8+256;21+256', 0, 1, 225, 0, 1);
INSERT INTO `pms_attr` VALUES (1505155324505178114, '上市时间', 1, 'post', '2020;2021', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (1505155449545768961, '尺寸', 1, 'dashboard', '6.7寸', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (1505155604445609986, '芯片', 1, 'icon_zan', '麒麟;高通;联发科', 1, 1, 225, 1, 0);
...
CREATE TABLE `pms_attr_attrgroup_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505155604462387203 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1505155324505178115, 1505155324505178114, 1504293112875573249, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1505155449554157569, 1505155449545768961, 1504293112875573249, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1505155604462387202, 1505155604445609986, 1504711444099379201, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1505081234566111234 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1504293112875573249, '基本信息', 3, '基本信息', 'email', 225);
INSERT INTO `pms_attr_group` VALUES (1504711444099379201, '主体', 2, '主体', 'log', 225);
INSERT INTO `pms_attr_group` VALUES (1505081234566111233, '主体', 1, '主体', 'download', 363);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1511916529556496386 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1503923754248581122, '华为', 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-19/1f0a73fe-ee6b-4c69-8749-0bc3fc5dee3e_天气.png', '爱国！！！', 1, 'h', 2);
INSERT INTO `pms_brand` VALUES (1503971604152057858, '小米', 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-16/007310da-e36b-4f85-88b2-014fe1dc1473_百叶窗后，蓝衣短裤长发美女私房写真照(1-10).jpg', '米猴子', 1, 'm', 3);
INSERT INTO `pms_brand` VALUES (1503971694166016001, '苹果', 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-16/007310da-e36b-4f85-88b2-014fe1dc1473_超高清美女图片，温柔的牛仔裤长发美少女私房写真日记(1-9).jpg', '果蛆', 1, 'a', 4);
INSERT INTO `pms_brand` VALUES (1503971753699966978, 'VIVO', 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-16/007310da-e36b-4f85-88b2-014fe1dc1473_晨起刷牙的可爱丸子头小姐姐睡衣短裤清新居家私房照(1-8).jpg', '傻子买', 1, 'v', 4);
INSERT INTO `pms_brand` VALUES (1504286299555762178, 'OPPO', 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-17/f2b1ff60-1a46-4e23-8042-bf86db43697b_白色樱花~蓝色轻纱露背连衣裙装红唇美女唯美性感私房摄影写真(1-13).jpg', '老人机', 1, 'o', 4);
INSERT INTO `pms_brand` VALUES (1504287578159976449, '一加', 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-17/f73502a9-3988-42db-8fc6-a88811a1b653_超可爱迷人的美胸妹子自拍写真，生活照图片(1-6).jpg', '一加', 1, 'y', 2);
INSERT INTO `pms_brand` VALUES (1511916529556496385, '荣耀', 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-04-07/2abe3f0c-c766-4f8f-8e4f-bd1da7c5db5f_logo.png', '卖手机的', 1, 'r', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1507276082912038915 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品三级分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category
-- ----------------------------
INSERT INTO `pms_category` VALUES (1, '图书、音像、电子书刊', 0, 1, 1, 17, 'documentation', '12', 0);
INSERT INTO `pms_category` VALUES (2, '手机', 0, 1, 1, 4, 'date', '', 0);
INSERT INTO `pms_category` VALUES (3, '家用电器', 0, 1, 1, 1, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (4, '数码', 0, 1, 1, 2, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (5, '家居家装', 0, 1, 1, 13, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (6, '电脑办公', 0, 1, 1, 5, 'svg_collect', '1', 0);
INSERT INTO `pms_category` VALUES (7, '厨具', 0, 1, 1, 3, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (8, '个护化妆', 0, 1, 1, 6, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (9, '服饰内衣', 0, 1, 1, 15, 'dict', '1', 0);
INSERT INTO `pms_category` VALUES (10, '钟表', 0, 1, 1, 14, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (11, '鞋靴', 0, 1, 1, 7, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (12, '母婴', 0, 1, 1, 8, 'cascader', '', 0);
INSERT INTO `pms_category` VALUES (13, '礼品箱包', 0, 1, 1, 9, 'download', NULL, 0);
INSERT INTO `pms_category` VALUES (14, '食品饮料、保健食品', 0, 1, 1, 10, 'download', '1', 0);
INSERT INTO `pms_category` VALUES (15, '珠宝', 0, 1, 1, 11, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (16, '汽车用品', 0, 1, 1, 12, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (17, '运动健康', 0, 1, 1, 0, 'date', 'kg', 0);
...
INSERT INTO `pms_category` VALUES (22, '电子书刊', 1, 2, 1, 0, 'documentation', '2', 0);
...
INSERT INTO `pms_category` VALUES (34, '手机通讯', 2, 2, 1, 0, 'dashboard', '1', 0);
...
INSERT INTO `pms_category` VALUES (49, '家纺', 5, 2, 1, 0, 'component', '', 0);
...
INSERT INTO `pms_category` VALUES (225, '手机', 34, 3, 1, 0, 'wechat', '部', 0);
...
INSERT INTO `pms_category` VALUES (1503621439385907202, '1', 1, 2, 0, 0, '1', '1', NULL);
INSERT INTO `pms_category` VALUES (1503623446934990849, '1', 36, 3, 0, 0, 'chart', '1', NULL);
INSERT INTO `pms_category` VALUES (1503729105402306561, '1', 2, 2, 0, 0, 'date-range', '1', NULL);
INSERT INTO `pms_category` VALUES (1503729173597495297, '1', 2, 2, 0, 0, 'date', '1', NULL);
INSERT INTO `pms_category` VALUES (1503936068058230786, 'maxlength=\"50\"maxlength=\"50\"maxlength=\"50\"maxlengt', 2, 2, 0, 0, '', '', NULL);
INSERT INTO `pms_category` VALUES (1503939025633935361, '啊', 2, 2, 0, 0, 'component', '啊', 0);
INSERT INTO `pms_category` VALUES (1504103810340691969, '1', 2, 2, 0, 0, 'download', '12', NULL);
INSERT INTO `pms_category` VALUES (1504103901780713474, '1', 2, 2, 0, 0, 'date-range', '1', NULL);
INSERT INTO `pms_category` VALUES (1504103949604167681, '2', 2, 2, 0, 0, 'email', '1', NULL);
INSERT INTO `pms_category` VALUES (1504104195851755521, '1', 2, 2, 0, 0, 'clipboard', '4', NULL);
INSERT INTO `pms_category` VALUES (1504104268480323585, '24', 1, 2, 0, 0, 'star', '1', NULL);
INSERT INTO `pms_category` VALUES (1504105721865379841, '214214', 2, 2, 0, 0, 'tree', '124', 0);
INSERT INTO `pms_category` VALUES (1504105809450835969, '124', 2, 2, 0, 0, 'time', '124', 0);
INSERT INTO `pms_category` VALUES (1504109194178666498, '1', 2, 2, 0, 0, 'clipboard', '1', 0);
INSERT INTO `pms_category` VALUES (1507276082912038914, '跑车', 21, 2, 1, 0, 'system', '辆', NULL);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1511916573047234563 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (1504283690287648769, 1503923754248581122, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (1504287344465940481, 1503923754248581122, 770, '华为', '智能手表');
INSERT INTO `pms_category_brand_relation` VALUES (1504287474292232194, 1503971604152057858, 250, '小米', '平板电视');
INSERT INTO `pms_category_brand_relation` VALUES (1504287507553062913, 1503971604152057858, 449, '小米', '笔记本');
INSERT INTO `pms_category_brand_relation` VALUES (1504289830044061697, 1503923754248581122, 449, '华为', '笔记本');
INSERT INTO `pms_category_brand_relation` VALUES (1504404410433527809, 1504287578159976449, 226, '一加', '对讲机');
INSERT INTO `pms_category_brand_relation` VALUES (1504404467358621697, 1504287578159976449, 272, '一加', '电压力锅');
INSERT INTO `pms_category_brand_relation` VALUES (1504404504457240577, 1504287578159976449, 379, '一加', '便携/无线音箱');
INSERT INTO `pms_category_brand_relation` VALUES (1504404547264307202, 1504286299555762178, 291, 'OPPO', '净化器');
INSERT INTO `pms_category_brand_relation` VALUES (1504830334618533889, 1503923754248581122, 231, '华为', '移动电源');
INSERT INTO `pms_category_brand_relation` VALUES (1504842022684164098, 1503971694166016001, 233, '苹果', '蓝牙耳机');
INSERT INTO `pms_category_brand_relation` VALUES (1505126472076713986, 1503971604152057858, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (1506663157256122369, 1503923754248581122, 916, '华为', '军刀军具');
INSERT INTO `pms_category_brand_relation` VALUES (1508811643791532033, 1503971694166016001, 231, '苹果', '移动电源');
INSERT INTO `pms_category_brand_relation` VALUES (1508811675584356353, 1504286299555762178, 474, 'OPPO', '鼠标');
INSERT INTO `pms_category_brand_relation` VALUES (1511916573047234562, 1511916529556496385, 225, '荣耀', '手机');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1506986543853268995 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (1505536688123486210, 1505536687041355778, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505536688123486211, 1505536687041355778, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505539607715586050, 1505539607434567682, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505539607715586051, 1505539607434567682, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505539607715586052, 1505539607434567682, 1505155604445609986, '芯片', '麒麟', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505540772087930882, 1505540771899187201, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505540772096319489, 1505540771899187201, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505540772096319490, 1505540771899187201, 1505155604445609986, '芯片', '麒麟', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505547655196647425, 1505547655116955650, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505547655196647426, 1505547655116955650, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505547655196647427, 1505547655116955650, 1505155604445609986, '芯片', '麒麟', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505551353410953218, 1505551353218015233, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505551353410953219, 1505551353218015233, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505551353410953220, 1505551353218015233, 1505155604445609986, '芯片', '麒麟', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505558340253196290, 1505558340186087425, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505558340253196291, 1505558340186087425, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505558340253196292, 1505558340186087425, 1505155604445609986, '芯片', '高通', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505559252472373249, 1505559252136828930, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505559252472373250, 1505559252136828930, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505559252472373251, 1505559252136828930, 1505155604445609986, '芯片', '高通', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505562378881409027, 1505562378881409025, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505562378881409028, 1505562378881409025, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505562378881409029, 1505562378881409025, 1505155604445609986, '芯片', '麒麟', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505563424194240514, 1505563424185851906, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505563424194240515, 1505563424185851906, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505563424194240516, 1505563424185851906, 1505155604445609986, '芯片', '高通', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505564128946364418, 1505564128891838466, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505564128954753026, 1505564128891838466, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505564128954753027, 1505564128891838466, 1505155604445609986, '芯片', '联发科', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505564749330063361, 1505564749262954497, 1505155324505178114, '上市时间', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505564749330063362, 1505564749262954497, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1505564749330063363, 1505564749262954497, 1505155604445609986, '芯片', '麒麟', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1506974497933815810, 1505565742805491713, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1506986543798743042, 1505566927104974849, 1505155324505178114, '上市时间', '2021', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1506986543853268993, 1505566927104974849, 1505155449545768961, '尺寸', '6.7寸', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (1506986543853268994, 1505566927104974849, 1505155604445609986, '芯片', '高通', NULL, 1);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505564749518807042 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1505539799873429505, 1505539799055540225, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/8db6c5e5-b731-45a3-8662-36f976583d5f_华为2.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505540772289257473, 1505540772230537217, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/8db6c5e5-b731-45a3-8662-36f976583d5f_华为2.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505547655309893635, 1505547655309893634, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/fd5f361a-d027-4076-82af-38836bf47e76_59ad4b5ba3756b55.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505551353612279811, 1505551353612279810, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/4979f9f3-f471-450b-8286-0e7a2ce8c40d_59ad4b5ba3756b55.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505551353683582979, 1505551353683582978, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/4979f9f3-f471-450b-8286-0e7a2ce8c40d_59ad4b5ba3756b55.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505559252598202371, 1505559252598202370, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/9b7fa617-de83-4f43-8df5-951a60f1d8db_华为1.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505562379166621697, 1505562379158233089, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/d5682b11-94c5-4995-8491-aa06a8e7b782_华为logo1.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505563424508813314, 1505563424508813313, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/c2eece61-6913-4c1c-8594-bf777df1cbb8_华为2.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505564129080582147, 1505564129080582146, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/70abac52-4dde-4033-8740-7c79618313a7_华为1.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (1505564749518807042, 1505564749451698177, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/22be6df5-05ca-494d-8cd8-13b260b9655b_华为2.jpg', NULL, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1505566927721537538 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1505540772230537217, 1505540771899187201, '华为 Mate 40 pro  黄色 8+256', NULL, 225, 1503923754248581122, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/8db6c5e5-b731-45a3-8662-36f976583d5f_华为2.jpg', '华为 Mate 40 pro  黄色 8+256', '副标题', 2999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505547655309893634, 1505547655116955650, '华为 P60 黄色 8+256', NULL, 225, 1503923754248581122, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/fd5f361a-d027-4076-82af-38836bf47e76_59ad4b5ba3756b55.jpg', '华为 P60 黄色 8+256', '华为 P60 黄色 8+256', 1999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505551353612279810, 1505551353218015233, '华为 P30 黄色 8+256', NULL, 225, 1503923754248581122, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/4979f9f3-f471-450b-8286-0e7a2ce8c40d_59ad4b5ba3756b55.jpg', '华为 P30 黄色 8+256', '华为 P30 黄色 8+256', 1.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505551353683582978, 1505551353218015233, '华为 P30 黄色 6+128', NULL, 225, 1503923754248581122, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/4979f9f3-f471-450b-8286-0e7a2ce8c40d_59ad4b5ba3756b55.jpg', '华为 P30 黄色 6+128', '华为 P30 黄色 8+256', 555.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505558340383219713, 1505558340186087425, '小米 12 pro 黑色 6+128', NULL, 225, 1503971604152057858, '', '小米 12 pro 黑色 6+128', '小米 12 pro 黑色 6+128', 1999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505559252598202370, 1505559252136828930, '小米11 黑色 6+128', NULL, 225, 1503971604152057858, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/9b7fa617-de83-4f43-8df5-951a60f1d8db_华为1.jpg', '小米11 黑色 6+128', '小米11 黑色 6+128', 111.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505562379158233089, 1505562378881409025, '小米 10  黄色 8+256', NULL, 225, 1503971604152057858, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/d5682b11-94c5-4995-8491-aa06a8e7b782_华为logo1.jpg', '小米 10  黄色 8+256', '小米 10  黄色 8+256', 111.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505563424508813313, 1505563424185851906, '小米 9  黄色 8+256', NULL, 225, 1503971604152057858, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/c2eece61-6913-4c1c-8594-bf777df1cbb8_华为2.jpg', '小米 9  黄色 8+256', '小米 9  黄色 8+256', 11111.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505564129080582146, 1505564128891838466, '小米 8  黄色 8+256', NULL, 225, 1503971604152057858, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/70abac52-4dde-4033-8740-7c79618313a7_华为1.jpg', '小米 8  黄色 8+256', '小米 8  黄色 8+256', 1999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505564749451698177, 1505564749262954497, '小米 6 黄色 6+128', NULL, 225, 1503971604152057858, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/22be6df5-05ca-494d-8cd8-13b260b9655b_华为2.jpg', '小米 6 黄色 6+128', '小米 6 黄色 6+128', 1444.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505565743061344257, 1505565742805491713, '小米 5 黄色 8+256', NULL, 225, 1503971604152057858, '', '小米 5 黄色 8+256', '小米 5 黄色 8+256', 111.0000, 0);
INSERT INTO `pms_sku_info` VALUES (1505566927721537537, 1505566927104974849, '小米 4 黄色 8+256', NULL, 225, 1503971604152057858, '', '小米 4 黄色 8+256', '小米 4 黄色 8+256', 188.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505566927721537539 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505540772289257474, 1505540772230537217, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505540772289257475, 1505540772230537217, 1505154845024927745, '内存', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505547655309893636, 1505547655309893634, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505547655372808194, 1505547655309893634, 1505154845024927745, '内存', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505551353612279812, 1505551353612279810, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505551353683582977, 1505551353612279810, 1505154845024927745, '内存', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505551353683582980, 1505551353683582978, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505551353683582981, 1505551353683582978, 1505154845024927745, '内存', '6+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505558340383219714, 1505558340383219713, 1504719409409875969, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505558340383219715, 1505558340383219713, 1505154845024927745, '内存', '6+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505559252665311233, 1505559252598202370, 1504719409409875969, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505559252665311234, 1505559252598202370, 1505154845024927745, '内存', '6+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505562379166621698, 1505562379158233089, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505562379166621699, 1505562379158233089, 1505154845024927745, '内存', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505563424508813315, 1505563424508813313, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505563424508813316, 1505563424508813313, 1505154845024927745, '内存', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505564129080582148, 1505564129080582146, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505564129080582149, 1505564129080582146, 1505154845024927745, '内存', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505564749527195649, 1505564749451698177, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505564749527195650, 1505564749451698177, 1505154845024927745, '内存', '6+128', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505565743061344258, 1505565743061344257, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505565743061344259, 1505565743061344257, 1505154845024927745, '内存', '8+256', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505566927721537538, 1505566927721537537, 1504719409409875969, '颜色', '黄色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (1505566927721537539, 1505566927721537537, 1505154845024927745, '内存', '8+256', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505566927440519170 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (1505540771899187202, 1505540771899187201, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/8db6c5e5-b731-45a3-8662-36f976583d5f_华为2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505547655192453122, 1505547655116955650, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/fd5f361a-d027-4076-82af-38836bf47e76_59ad4b5ba3756b55.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505551353364815874, 1505551353218015233, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/4979f9f3-f471-450b-8286-0e7a2ce8c40d_59ad4b5ba3756b55.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505558340186087426, 1505558340186087425, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/d7abb519-737d-4dce-8220-b8fba7ad38f5_华为logo1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505559252329766913, 1505559252136828930, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/9b7fa617-de83-4f43-8df5-951a60f1d8db_华为1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505562378881409026, 1505562378881409025, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/d5682b11-94c5-4995-8491-aa06a8e7b782_华为logo1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505563424194240513, 1505563424185851906, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/c2eece61-6913-4c1c-8594-bf777df1cbb8_华为2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505564128891838467, 1505564128891838466, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/70abac52-4dde-4033-8740-7c79618313a7_华为1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505564749317480449, 1505564749262954497, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/22be6df5-05ca-494d-8cd8-13b260b9655b_华为2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505565742805491714, 1505565742805491713, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/099cf4dd-7894-45d7-8aa8-f1c2d64b1a0f_华为1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (1505566927440519170, 1505566927104974849, NULL, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/1cde924e-39e8-4fb4-82c0-e321f4030fc5_华为1.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505566927104974850 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (1505540771899187201, '华为 Mate 40 pro ', '华为 Mate 40 pro ', 225, 1503923754248581122, 0.2000, 0, '2022-03-20 21:44:26', '2022-03-20 21:44:26');
INSERT INTO `pms_spu_info` VALUES (1505547655116955650, '华为 P60', '华为 P60', 225, 1503923754248581122, 0.3000, 0, '2022-03-20 22:11:47', '2022-03-20 22:11:47');
INSERT INTO `pms_spu_info` VALUES (1505551353218015233, '华为 P30', '华为 P30', 225, 1503923754248581122, 0.3000, 0, '2022-03-20 22:26:29', '2022-03-20 22:26:29');
INSERT INTO `pms_spu_info` VALUES (1505558340186087425, '小米 12 pro', '小米 12 pro', 225, 1503971604152057858, 0.2000, 0, '2022-03-20 22:54:15', '2022-03-20 22:54:15');
INSERT INTO `pms_spu_info` VALUES (1505559252136828930, '小米11', '小米11', 225, 1503971604152057858, 0.2000, 0, '2022-03-20 22:57:52', '2022-03-20 22:57:52');
INSERT INTO `pms_spu_info` VALUES (1505562378881409025, '小米 10 ', '小米 10 ', 225, 1503971604152057858, 0.1000, 0, '2022-03-20 23:10:18', '2022-03-20 23:10:18');
INSERT INTO `pms_spu_info` VALUES (1505563424185851906, '小米 9 ', '小米 9 ', 225, 1503971604152057858, 0.2000, 0, '2022-03-20 23:14:27', '2022-03-20 23:14:27');
INSERT INTO `pms_spu_info` VALUES (1505564128891838466, '小米 8 ', '小米 8 ', 225, 1503971604152057858, 0.4000, 0, '2022-03-20 23:17:15', '2022-03-20 23:17:15');
INSERT INTO `pms_spu_info` VALUES (1505564749262954497, '小米 6', '小米 6', 225, 1503971604152057858, 0.2000, 0, '2022-03-20 23:19:43', '2022-03-20 23:19:43');
INSERT INTO `pms_spu_info` VALUES (1505565742805491713, '小米 5', '小米 5', 225, 1503971604152057858, 0.3000, 0, '2022-03-20 23:23:40', '2022-03-20 23:23:40');
INSERT INTO `pms_spu_info` VALUES (1505566927104974849, '小米 4', '小米 4', 225, 1503971604152057858, 0.2000, 1, '2022-03-20 23:28:22', '2022-04-06 17:00:09');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (1505540771899187201, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/41a4bd32-13d1-4794-824c-96b766b7981a_华为logo1.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505547655116955650, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/a9c3e788-1462-4314-8e76-8836fdf9adf5_华为2.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505551353218015233, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/6a8e638d-0fb4-4c77-821e-d2061b2f38b6_华为logo1.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505558340186087425, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/e2a71be8-262a-4a18-8310-1476abaf09b3_59ad4b5ba3756b55.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505559252136828930, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/6016ef1c-89bd-473e-8f29-627ae7f9b89d_59ad4b5ba3756b55.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505562378881409025, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/89afa92f-3e46-4cb7-8da9-eb033abdd85b_59ad4b5ba3756b55.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505563424185851906, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/98f84b14-8c1f-43d2-81ac-bf560fd11f07_华为logo1.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505564128891838466, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/75d6574a-9d0d-46c2-8280-1450d7f2e65c_59ad4b5ba3756b55.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505564749262954497, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/bcfe521a-3f52-4c87-803f-39e05eb984f4_华为logo1.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505565742805491713, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/97850cec-0cbb-4edb-883b-2f3c03310996_华为logo1.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (1505566927104974849, 'https://xjs-cloud.oss-cn-hangzhou.aliyuncs.com/2022-03-20/b9412eb6-b5c1-4994-83d9-534a53194eab_华为logo1.jpg');
...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505544982560899074 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品会员价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (1505540772360486916, 1505540772230537217, 1504846789581967362, '黄金会员', 2888.0000, 1);
INSERT INTO `sms_member_price` VALUES (1505544982560899074, 1505544534949044225, 1504846789581967362, '黄金会员', 2777.0000, 1);
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '秒杀活动场次' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505544982342795265 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品满减信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (1505540772360486915, 1505540772230537217, 5000.0000, 50.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (1505544982342795265, 1505544534949044225, 10.0000, 1.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505544982049193986 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品阶梯价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1505540772360486914, 1505540772230537217, 2, 1.00, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (1505544982049193986, 1505544534949044225, 2, 0.90, NULL, 0);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1505566927637577730 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (1505540772159160321, 1505540771899187201, 5.0000, 4.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505544384826441730, 1505544374437224450, 100.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505544534621814785, 1505544534487670786, 100.0000, 10.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505547475269320705, 1505547465710575617, 4.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505547655251099650, 1505547655116955650, 4.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505551353482182657, 1505551353218015233, 2.0000, 2.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505558340253122561, 1505558340186087425, 5.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505559252551991297, 1505559252136828930, 0.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505562378956832769, 1505562378881409025, 2.0000, 2.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505563424236109825, 1505563424185851906, 3.0000, 2.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505564128954679298, 1505564128891838466, 2.0000, 2.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505564749392904194, 1505564749262954497, 0.0000, 2.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505565742876721153, 1505565742805491713, 3.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (1505566927637577730, 1505566927104974849, 0.0000, 0.0000, NULL);
...
CREATE TABLE `ums_member_level`  (
  ...
  `note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1504846789581967363 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '会员等级' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_member_level
-- ----------------------------
INSERT INTO `ums_member_level` VALUES (1, '青铜会员', 10, 1, 100.0000, 1, 0, 0, 1, '青铜会员');
INSERT INTO `ums_member_level` VALUES (2, '白银会员', 50, 0, 90.0000, 2, 0, 1, 1, '白银会员');
INSERT INTO `ums_member_level` VALUES (1504846789581967362, '黄金会员', 100, 0, 80.0000, 3, 1, 1, 1, '黄金会员');
...
CREATE TABLE `wms_purchase`  (
  ...
  `update_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1506924201941643267 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '采购信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_purchase
-- ----------------------------
INSERT INTO `wms_purchase` VALUES (1506662045144731649, 1, 'admin', '18907084291', 11, 1, NULL, NULL, NULL, '2022-03-24 17:48:54');
INSERT INTO `wms_purchase` VALUES (1506924201941643266, 100, 'test', '17607993928', 0, 1, NULL, NULL, '2022-03-24 17:21:42', '2022-03-24 17:22:55');
...
CREATE TABLE `wms_purchase_detail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1506924167061811203 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_purchase_detail
-- ----------------------------
INSERT INTO `wms_purchase_detail` VALUES (1506656021314686977, 1506662045144731649, 1505566927721537537, 800, NULL, 1506588753864105985, 1);
INSERT INTO `wms_purchase_detail` VALUES (1506904616420999169, 1506662045144731649, 1505566927721537537, 4, NULL, 1506584936426708993, 1);
INSERT INTO `wms_purchase_detail` VALUES (1506924167061811202, 1506924201941643266, 1505566927721537537, 3, NULL, 1506586311478943746, 1);
...
CREATE TABLE `wms_ware_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1510577500800593922 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '仓库信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_ware_info
-- ----------------------------
INSERT INTO `wms_ware_info` VALUES (1506584936426708993, '三号仓库', '江苏省 南通市 如皋市', '320682');
INSERT INTO `wms_ware_info` VALUES (1506586311478943746, '四号仓库', '辽宁省 葫芦岛市 建昌县 西碱厂乡', '211422');
INSERT INTO `wms_ware_info` VALUES (1506586883946913794, '一号仓库', '江西省 南昌市 东湖区 八一桥街道-八一广场二号街', '360102');
INSERT INTO `wms_ware_info` VALUES (1506588753864105985, '二号仓库', '辽宁省 抚顺市 望花区 建设街道-1221', '210404');
INSERT INTO `wms_ware_info` VALUES (1506914483168837634, '五号仓库', '湖北省 宜昌市 兴山县 峡口镇-哇', '420526');
INSERT INTO `wms_ware_info` VALUES (1507324972222902274, '总仓库', '广东省 汕头市 濠江区 达濠街道-地点', '440512');
INSERT INTO `wms_ware_info` VALUES (1510577500800593921, '小仓库', '江苏省 宿迁市 泗洪县 车门乡-xx', '321324');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1506633555838218243 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品库存' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_ware_sku
-- ----------------------------
INSERT INTO `wms_ware_sku` VALUES (1506633555838218242, 1505566927721537537, 1506588753864105985, 999, '小米12', 13);
